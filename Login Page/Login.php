...
if ($_SERVER['REQUEST_METHOD'] == 'POST'){
  ...
  $insertionquery="SELECT * FROM `credentials` WHERE email='$email' AND password='$password';";
  ...
  if($num==1)
  {
    ...
    $_SESSION['Collegename']=$data['Collegename'];
...
<body>
        ...
        <div
            ...
            <div
                ...
                <div class="my-3 text-4xl font-bold tracking-wider text-center">
                    <a href="#"><img src="../index.png" alt="logo" srcset=""></spam></a>
                </div>
                <p class="mt-6 font-normal text-center text-gray-300 md:mt-0">
                    Welcome to Condacoders... 
                    A integrated platform for information about
                    lndian Universities
                </p>
            ...
            <div class="p-5 bg-white md:flex-1">
                ...
                <form action="Login.php"  method="POST" class="flex flex-col space-y-5">
    ...
    <a href="./Login Page/Login.html">dead</a>
</body>
